...
export const TOP_AREAS = [
  {
    id: 1,
    image: require('../../assets/images/cameras/LivingRoom.jpeg'),
    title: 'Living Room',
    location: 'Italy',
    description:
      'The ultimate Amalfi Coast travel guide, where to stay, where to eat, and what areas to visit in the Amalfi Coast of Italy. Positano, Ravello, Amalfi and more',
  ...
  {
    id: 4,
    image: require('../../assets/images/cameras/MainGate.jpeg'),
    title: 'Main Gate',
    location: 'Spain',
    description:
      'Granada is the capital city of the province of Granada, in the autonomous community of Andalusia, Spain',
  ...
  {
    id: 6,
    image: require('../../assets/images/cameras/Backyard.jpeg'),
    title: 'Backyard',
    location: 'Japan',
    description:
      "Cherry blossoms usually bloom between mid-March and early May. In 2022, Tokyo's cherry blossom season officially began on March 20",
...
export const CAMERAS = [
  {
    id: 5,
    image: require('../../assets/images/cameras/GateCamera1.jpg'),
    title: 'Camera 1',
    location: 'Gate',
    description:
      "Cappadocia's landscape includes dramatic expanses of soft volcanic rock, shaped by erosion into towers, cones, valleys, and caves. Rock-cut churches and underground tunnel complexes from the Byzantine and Islamic eras are scattered throughout the countryside.",
  ...
  {
    id: 4,
    image: require('../../assets/images/cameras/GateCamera2.jpg'),
    title: 'Camera 2',
    location: 'Gate',
    description:
      "Cappadocia's landscape includes dramatic expanses of soft volcanic rock, shaped by erosion into towers, cones, valleys, and caves. Rock-cut churches and underground tunnel complexes from the Byzantine and Islamic eras are scattered throughout the countryside.",
  ...
  {
    id: 2,
    image: require('../../assets/images/cameras/BedRoomCamera1.jpg'),
    title: 'Camera 4',
    location: 'BedRoom',
    description:
      "Cappadocia's landscape includes dramatic expanses of soft volcanic rock, shaped by erosion into towers, cones, valleys, and caves. Rock-cut churches and underground tunnel complexes from the Byzantine and Islamic eras are scattered throughout the countryside.",
  ...
  {
    id: 4,
    image: require('../../assets/images/cameras/KitchenCamera1.jpg'),
    title: 'Camera 5',
    location: 'Kitchen',
    description:
      "Cappadocia's landscape includes dramatic expanses of soft volcanic rock, shaped by erosion into towers, cones, valleys, and caves. Rock-cut churches and underground tunnel complexes from the Byzantine and Islamic eras are scattered throughout the countryside.",
...
export const SEARCH_CCTVS = [...CAMERAS, ...TOP_AREAS].map(item => ({
  ...item,
  id: Math.random().toString(),
})); 
export const SEARCH_TODAY = [...Object.values(HOTELS)].map(item => ({
  ...item,
  id: Math.random().toString(),
}));
...
export const SEARCH_ALL = [...SEARCH_CCTVS, ...SEARCH_TODAY];
